...
class Paging {
	...
	/* Whenever instance of Paging class is created using this fiunction
	 * it will return the url of current page
	 */
	...
	/* Gives count of number of pages
	 * 
	 */
	...
	/* Function to the records finds last record to be 
	 * shown on page $out initiated with empty array
	 */
